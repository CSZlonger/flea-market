...
export default {
  ...
  methods:{
      query(){
        var that = this;
        this.$axios.get('http://127.0.0.1:10001/sys/user/list',
        {headers: {
      ...
      onSubmit(e){
        ...
        this.$axios.post('http://127.0.0.1:10001/sys/user/' + action, 
            data,
            {
      ...
      getInfo(id){
        var that = this;
        this.$axios.get('http://127.0.0.1:10001/sys/user/info/'+id,
        {headers: {
            'token': localStorage.getItem("atoken")
        },
            params: {}
      ...
      del(){
        ...
        var that = this;
        this.$axios.post('http://127.0.0.1:10001/sys/user/delete',
            that.ids,
            {
                headers: {'token': localStorage.getItem("atoken")}
            }).then(function(res){
